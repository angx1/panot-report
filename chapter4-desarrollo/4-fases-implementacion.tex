...
interacciones ni en la creación de contactos \textit{hablando sobre ellos}. Lo implementado fue una solución temporal.
...
\begin{figure}[ht!]
    ...
    \caption{Ejemplo de traza de ejecución en LangSmith del sistema multi-agente de PANOT}
...
\gls{landing} de PANOT tanto en inglés como en español además de incorporar la sección de gestión de cuenta en la aplicación, donde el usuario 
