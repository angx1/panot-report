...
\label{sec:filosofia-metodologia-desarrollo}
...
finalización de un producto comercial definitivo, sino la construcción y despliegue de un \acrshort{mvp} que 
...
\label{sec:metodologia-flujo-desarrollo}
...
\begin{figure}
    \centering
        \includegraphics[width=.75\textwidth]{figures/gitflow-diagram.png}
...
\begin{itemize}
    ...
    por cambio de contexto, se mantiene un límite de trabajo en curso (\acrfull{wip}) estricto de una única tarea simultánea.
