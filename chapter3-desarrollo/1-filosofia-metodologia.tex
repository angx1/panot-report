...
Para organizar de manera robusta y estable la carga de trabajo de proyecto, se ha optado por la adopción de la metodología de ramificación \textit{GitFlow}.
...
tras ser completadas y validadas (ver figura \ref{fig:gitflow-diagram}). Esta estrategia garantiza la estabilidad del sistema al evitar que el código en desarrollo comprometa la funcionalidad base.
...
\begin{itemize}
    ...
    por cambio de contexto, se mantiene un límite de trabajo en curso (WIP) estricto de una única tarea simultánea.
...
\begin{figure}
    ...
    \caption{Visualización de las columnas del tablero Kanban implementado en GitHub Projects en un punto del desarrollo. Se destaca el límite de trabajo en curso (WIP) 
