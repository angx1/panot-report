...
familiares para cualquier usuario de la plataforma. A continuación, se ilustran los flujos de la aplicación siguiendo las Historias de Usuario principales:

\subsubsection{Flujo de Registro de Usuario y Onboarding - \hyperref[req:HU-01]{HU-01}}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{figures/user-flow-onboarding.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{figures/user-flow-signin.png}
...
El siguiente flujo de usuario abarca las tres posibilidades de creación de un contacto: creación manual (camino \textit{1 - 2 - 4 - 9}), creación con dictado (camino \textit{1 - 2 - 5 - 10 - 11}) e 
...
\begin{figure}[H]
    ...
    \caption{Grafo de conocimiento resultante de la creación del contacto \textbf{Pedro} en {\scriptsize \texttt{graph-visualizer}}.}
    \label{fig:grafo-pedro}
\end{figure}


Posteriormente, al crear el contacto \textbf{Pepe}, el sistema activa el \textit{matching semántico} para identificar nodos comunes entre los contactos. Como se evidencia en la Figura \ref{fig:grafo-pedro-pepe-inicial}, el sistema 
...
\begin{figure}[H]
    ...
    \caption{Grafo de conocimiento resultante de la creación del contacto \textbf{Pepe} y la detección de nodos comunes con el contacto \textbf{Pedro} en {\footnotesize \texttt{graph-visualizer}}.}
...
Los siguientes flujos de creación y procesamiento de una interacción que se exponen a continuación corresponden a dos variantes: la primera (\hyperref[fig:new-interaction-long]{I}) corresponde a asignación de la interacción a un 
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{figures/user-flow-new-interaction-short.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{figures/grafo-pedro-pepe-ni.png}
    \caption{Grafo de conocimiento resultante de los contactos \textbf{Pepe} y \textbf{Pedro} tras procesar las nuevas interacciones en {\footnotesize \texttt{graph-visualizer}}.}
    \label{fig:grafo-pedro-pepe-nueva-interaccion}
\end{figure}

\subsubsection{Flujo de Edición o Eliminación de Contacto - \hyperref[req:HU-05]{HU-05}}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{figures/user-flow-contact-edit.png}
    \caption{Flujo de Edición o Eliminación de Contacto}
    \label{fig:contact-edit}
\end{figure}

\subsubsection{Flujo de Búsqueda de Contacto - \hyperref[req:HU-07]{HU-07}}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{figures/user-flow-contact-search.png}
    \caption{Flujo de Búsqueda de Contacto}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{figures/user-flow-settings.png}
