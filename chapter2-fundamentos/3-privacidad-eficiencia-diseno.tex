...
ha sido consolidado legalmente en el \acrfull{rgpd} mediante su artículo 25, 
...
estrategias arquitectónicas. Por ejemplo, la adopción de arquitecturas serverless y \acrfull{faas} permite 
...
distribuido y \acrfull{cdn} en empresas como Amazon Web Services permite reducir la latencia y el 
...
\Acrfull{tpp} que permiten procesar datos manteniendo su confidencialidad.

Una de las técnicas más prometedoras en este ámbito es el \acrfull{fhe}, un paradigma criptográfico que, a diferencia del 
...
En este contexto, la privacidad requiere de proteger la información del usuario  
