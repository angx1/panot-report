...
Los \acrfull{crm} convencionales, si bien útiles en entornos corporativos para la gestión masiva de clientes, presentan 
...
El paradigma actual de la gestión de contactos ha evolucionado desde simples agendas digitales, a lo que ahora se denominan sistemas de \acrfull{prm}.
...
Esto supone una propuesta de valor muy fuerte, pero, aunque reduzcan la fricción de la inserción de datos, su enfoque es fundamentalmente 'archivístico'. Al operar sobre este tipo de fuentes de datos, carecen de 
un contexto situacional profundo, es decir, saben donde trabaja un contacto, pero no saben cómo se sienten respecto a su nuevo empleo o qué matiz emocional tuvo la última conversación.
...
La diferencia fundamental entre la Inteligencia Relacional y los paradigmas tradicionales de \acrshort{ia} radica en que, mientras estos últimos 
...
tal como ocurre en el razonamiento humano, creando un contexto de conocimiento más amplio y generalizable o específico para un dominio en concreto.
