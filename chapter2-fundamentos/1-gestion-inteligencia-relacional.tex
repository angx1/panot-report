...
El paradigma actual de la gestión de contactos ha evolucionado desde simples agentas digitales, a lo que ahora se denomina \textit{Gestión de Relaciones Personales} (\acrshort{prm}).
...
Esto supone una propuesta de valor muy fuerte, pero, aunque 
reduzcan la fricción de la insercción de datos, su enfoque es fundamentalmente 'archivístico'. Al operar sobre datos públicos y huellas digitales pasadas, carecen de 
...
que enmarca PANOT, se posicionaría en ese \textit{registro del entendimiento}.
...
mediante relaciones semánticas. A modo ilustrativo, esta sería la representación en formato \texttt{JSON}:
...
eventos, gustos, situaciones, necesidades, etc. —Ver \ref{fig:fig-gf-maria}— abstrayéndo el complejo contexto de la relación en una representación más simplificada.

\begin{figure}
	\centering
	\begin{subfigure}{.82\textwidth}
		 \includegraphics[width=\textwidth]{figures/grafo-contexto-maria.png}
	\end{subfigure}
	\vfill
	\begin{subfigure}{.82\textwidth}
		\includegraphics[width=\textwidth]{figures/grafo-contexto-maria-simplificado.png}
	\end{subfigure}
	 \caption{\label{fig:fig-gf-maria} Representación orientativa en MemGraph Lab del contexto del contacto «María» en formato grafo relacional. En el grafo de arriba con nodos CONTEXTO y en el de más abajo sin ellos.}
\end{figure}
