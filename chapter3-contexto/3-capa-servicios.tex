...
\begin{enumerate}
    ...
    headers de autenticación, valida los JSON Web Tokens (\acrshort{jwt}) y aplica reglas de enrutamiento y control de tráfico. De esta manera, se centralizan las comprobaciones de 
...
de pasarela de pagos. \textit{Stripe} es una plataforma Banking-as-a-Service (\acrshort{baas}) que proporciona \acrshort{api}s robustas y seguras para procesar pagos, 
...
proporciona un soporte nativo y para aplicaciones móviles con Kit de Desarrollo de Software (\acrshort{sdk}s) específicos para \textit{Expo}. \textit{Polar} 
