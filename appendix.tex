...
En este capítulo se analiza el impacto de PANOT desde una perspectiva más allá de la tecnológica, evaluándolo desde las dimensiones personal, social y medioambiental. 
Asimismo, se vincula la contribución del proyecto con algunos de los Objetivos de Desarrollo Sostenible (ODS) de las Naciones Unidas.

\section{Impacto Personal y Académico}

En lo personal y académico, el desarrollo de PANOT ha sido una herramienta de aprendizaje y crecimiento, permitiéndome aplicar y extender los conocimientos adquiridos durante el Grado de Ingeniería de Software. 
El proyecto me ha permitido consolidar competencias en el desarrollo de aplicaciones móviles multiplataforma, la orquestación de sistemas de agentes de \acrshort{ia}, la gestión de bases de datos y 
el uso de herramientas de observabilidad, además de la gestión planificada y organizada de un proyecto real.

Más allá de la implementación técnica, la mayor contribución a nivel personal de este proyecto, ha sido la adopción de una mentalidad orientada a la validación del producto por parte del usuario. 
Esta mentalidad ha transformado mi percepción sobre el ciclo de vida del software, valorando un aprendizaje validado por encima de una especificación rígida. Y encima de todo, PANOT me ha ayudado a entender que 
la calidad de un producto no reside únicamente en su código, sino en el proceso de crecimiento y adaptación de las personas que lo construyen.

\section{Impacto Social}

PANOT nace con el objetivo de permitir a sus usuarios ser más atentos e involucrados con sus relaciones personales. Las personas no somos nadie sin alguien a quien tener a 
nuestro lado. Ninguna gran compañía crece de una sola persona ya que la colaboración y un buen equipo es algo inherente en el crecimiento de cualquier emprendimiento o proyecto. 
Es decir, el éxito de cualquier iniciativa, ya sea personal o profesional, depende de la capacidad de colaborar y cuidar la comunidad que nos rodea. 

La solución que PANOT representa se vincula con el \textbf{ODS 3: Salud y Bienestar}, reconociendo que unas relaciones sociales sanas y cuidadas son un pilar fundamental para la 
salud mental y el crecimiento del individuo.


\section{Impacto Medioambiental}

Gracias a la arquitectura desarrollada, el sistema de PANOT refleja un compromiso con la sostenibilidad operativa y energética, fundamentado en el principio de \textit{Eficiencia por Diseño}. 

El uso de arquitecturas \textit{serverless} y el enfoque \textit{local-first} aseguran que el consumo de recursos computacionales ocurra únicamente bajo demanda, minimizando la 
energía desperdiciada por servidores inactivos. Por esta razón, el sistema contribuye al \textbf{ODS 12: Producción y Consumo Responsables}, al demostrar que es posible desarrollar software 
desplegado bajo criterios de eficiencia de recursos y sostenibilidad económica. No obstante, hay que tener en cuenta que el uso de modelos de lenguaje conlleva un alto consumo energético en las 
fases de entrenamiento e inferencia y que PANOT todavía no mitiga este impacto mediante una gestión eficiente del contexto a través de, por ejemplo, reducir el número de \textit{tokens} procesados 
para reducir la carga computacional requerida para la ejecución de peticiones.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=.8\textwidth]{figures/rls-graph.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=.8\textwidth]{figures/rls-interactions.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=.8\textwidth]{figures/rls-profiles.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=.8\textwidth]{figures/rls-process-queue.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=.8\textwidth]{figures/rls-contacts.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=.8\textwidth]{figures/rls-tickets.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=.8\textwidth]{figures/rls-workers.png}
...
\begin{enumerate}
    ...
    \item \textbf{Tiempo de Respuesta Medio ($\bar{T}$):} La media aritmética de los tiempos de respuesta. Esta métrica es el indicador principal de rendimiento esperado bajo una carga constante.
    \begin{equation}
...
\label{appendix:posthog-anonimizacion}
...
\label{appendix:posthog-verificacion-flujo-datos}
