...
\textbf{FR-03} \label{req:FR-03}       & El sistema debe proporcionar una funcionalidad explícita para que el usuario solicite la eliminación completa de su cuenta, lo que debe desencadenar el borrado de sus datos tanto en el dispositivo local como en el servidor remoto. \\ \hline
\end{tabularx}
...
\rowcolor[HTML]{EFEFEF} 
\textit{ID}                            & \textit{Descripción} \\ \hline
\textbf{FR-14} \label{req:FR-14}       & El sistema debe procesar la información de la interacción para actualizar los detalles del contacto, agregando la nueva información o eliminando la información obsoleta sin modificar el contexto histórico importante. \\ \hline
\textbf{FR-15} \label{req:FR-15}       & El sistema debe ser capaz de generar relaciones entre contactos basadas en la información de su descripción o las interacciones de entrada.\\ \hline
\end{tabularx}
...
Para complementar a la funcionalidad, es esencial que el sistema de PANOT mantenga cierto nivel de calidad. A continuacuón se enumeran los 
