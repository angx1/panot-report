...
\textit{ID} & \textit{Historia de Usuario} \\ \hline
    ...
    \textbf{HU-03} \label{req:HU-03} & \textit{Como} usuario, \textit{quiero} crear un contacto dictando su descripción \textit{para} permitir que ellos mismos lo hagan o hacerlo con el mínimo esfuerzo posible. \\ \hline
...
\hyperref[req:FR-04]{FR-04} & --- (necesidad técnica) \\ \hline
...
\end{tabular}
\caption{Matriz de Trazabilidad de Requitos e Historias de Usuario (I)}
\label{tab:matriz-trazabilidad-1}
\end{table}
...
\end{tabular}
\caption{Matriz de Trazabilidad de Requitos e Historias de Usuario (II)}
\label{tab:matriz-trazabilidad-2}
\end{table}
...
\end{tabularx}
\caption{Requisitos No Funcionales (I) del sistema: ID, Tipo, Descripción y Criterio de Aceptación}
\label{tab:non-functional-requirements-1}
\end{table}
...
\end{tabularx}
\caption{Requisitos No Funcionales (II) del sistema: ID, Tipo, Descripción y Criterio de Aceptación}
\label{tab:non-functional-requirements-2}
\end{table}
