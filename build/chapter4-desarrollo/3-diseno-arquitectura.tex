...
\begin{figure}[h]
    ...
    \caption{Diagrama de la arquitecturadel sistema multi-agente de PANOT. En naranje se representa el esquema de la petición enviada al sistema, en morado el agente orquestador, en rosa los agentes especializados y en azul las tablas abstraidas de la base de datos.}
