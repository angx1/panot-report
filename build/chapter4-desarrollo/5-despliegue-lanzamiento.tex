...
siguiendo las \acrfull{hig} \cite{apple-human-interface-guidelines} para asegurar una experiencia basada en los pilares de 
...
El lanzamiento principal se ha planificado en la plataforma \textit{Product Hunt} \ref{fig:product-hunt-launch}. Al tratarse de un sistema con un alto componente de innovación, resulta el escenario 
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{figures/product-hunt-launch.png}
    \caption{Captura hecha el dia 02/02/2026 de la publicación de PANOT en Product Hunt}
    \label{fig:product-hunt-launch}
\end{figure}