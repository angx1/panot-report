...
Para traducir estas hipótesis en funcionalidades concretas y mantener un enfoque centrado en el usuario, se han definido una serie de \acrfull{hu}. Estas historias actúan como unidades de trabajo que describen el \textit{quién}, el \textit{qué} y el \textit{para qué} de cada capacidad del sistema. \\
