...
\begin{itemize}
    ...
    \item \textbf{Capítulo 4. Desarrollo del Proyecto}: Documenta el ciclo de vida del sistema software que se pretende desarrollar (análisis - diseño - implementación - despliegue).
    ...
    \item \textbf{Capítulo 6. Conclusiones}: Describe las conclusiones generales del proyecto y las líneas de trabajo futuro.
\end{itemize}
